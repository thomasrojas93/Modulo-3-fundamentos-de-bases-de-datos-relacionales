...
select u.name, t.transaction_id, t.import_amount,t.transaction_date, t.sender_user_id,  t.receiver_user_id,
t.currency_id 
from transaction t
inner join User u on t.sender_user_id=u.user_id or t.receiver_user_id=u.user_id
where u.name='Pablo Perez';
